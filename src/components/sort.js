  ...
  getTemplate() {
    ...
    <div class="trip-sort__item trip-sort__item--event">
      ...
      <label
        ...
        for="sort-event"
        data-sort-type="event">Event</label>
    </div>
    <div class="trip-sort__item trip-sort__item--time"s>
      <input
        id="sort-time"
        class="trip-sort__input visually-hidden"
        type="radio"
      ...
      <label
        ...
        <svg
          ...
          height="10"
          viewBox="0 0 8 10">
          <path d="M2.888 4.852V9.694H5.588V4.852L7.91
            5.068L4.238 0.00999987L0.548 5.068L2.888 4.852Z"></path>
        </svg>
      </label>
    </div>
    <div
